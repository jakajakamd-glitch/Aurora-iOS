...
void environment_manager_t::load_environment(lua_State* thread) {
    ...
    lua_pushcclosurek(thread, [](lua_State* L) -> int {
        ...
        if (!found && managers::roblox_manager.scriptctx) {
            uintptr_t context = (uintptr_t)managers::roblox_manager.scriptctx;
